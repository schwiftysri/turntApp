...
import 'add_participants_model.dart';
export 'add_participants_model.dart';
...
class _AddParticipantsWidgetState extends State<AddParticipantsWidget> {
  late AddParticipantsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddParticipantsModel());
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await ParticipantsRecord.createDoc(widget.eventRef!)
                            .set(createParticipantsRecordData(
                          userName: _model.textController1.text,
                          userContactNo: _model.textController2.text,
