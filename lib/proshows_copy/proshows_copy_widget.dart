...
import 'proshows_copy_model.dart';
export 'proshows_copy_model.dart';

class ProshowsCopyWidget extends StatefulWidget {
  const ProshowsCopyWidget({
    Key? key,
    this.proshowsDates,
    this.festName,
    this.festYear,
  ...
  @override
  _ProshowsCopyWidgetState createState() => _ProshowsCopyWidgetState();
}

class _ProshowsCopyWidgetState extends State<ProshowsCopyWidget> {
  late ProshowsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProshowsCopyModel());
  }
