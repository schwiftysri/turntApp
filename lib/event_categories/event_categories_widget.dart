...
import 'event_categories_model.dart';
export 'event_categories_model.dart';
...
class EventCategoriesWidget extends StatefulWidget {
  ...
  @override
  _EventCategoriesWidgetState createState() => _EventCategoriesWidgetState();
}

class _EventCategoriesWidgetState extends State<EventCategoriesWidget> {
  late EventCategoriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventCategoriesModel());
  }
